    ...
    module.exports = function (app) {
        ...
        const schema = new Schema(
          {
            complainCategory: { type:  String , minLength: 2, index: true, trim: true, default: "", comment: "Complain Category, p, false, true, true, true, true, true, true, , , , ," },
...
machineImage: { type:  [Schema.Types.ObjectId], ref: "document_storages" , minLength: 2, index: true, trim: true, default: "", comment: "Machine Image, file_upload, false, true, true, true, true, true, true, , , , ," },
