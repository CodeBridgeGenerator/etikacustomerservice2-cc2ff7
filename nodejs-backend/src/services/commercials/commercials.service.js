const { Commercials } = require("./commercials.class");
const createModel = require("../../models/commercials.model");
const hooks = require("./commercials.hooks");
...
module.exports = function (app) {
  ...
  app.use("/commercials", new Commercials(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("commercials");

  // Get the schema of the collections 
  app.get("/commercialsSchema", function (request, response) {
