...
import seederData from "./commercials.seeder.json";
...
const CommercialsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CommercialsSeederDialogComponent);
