...
const ComplaintsDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.complainCategory}</p>
...
const pTemplate5 = (rowData, { rowIndex }) => <p >{rowData.additionalDetail}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="complainCategory" header="Complain Category" body={pTemplate0} filter={selectedFilterFields.includes("complainCategory")} hidden={selectedHideFields?.includes("complainCategory")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="machineImage" header="Machine Image" body={file_uploadTemplate4} filter={selectedFilterFields.includes("machineImage")} hidden={selectedHideFields?.includes("machineImage")}  sortable style={{ minWidth: "8rem" }} />
<Column field="additionalDetail" header="Additional Detail" body={pTemplate5} filter={selectedFilterFields.includes("additionalDetail")} hidden={selectedHideFields?.includes("additionalDetail")}  sortable style={{ minWidth: "8rem" }} />
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload Complaints Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
      ...
      <Dialog header="Search Complaints" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
