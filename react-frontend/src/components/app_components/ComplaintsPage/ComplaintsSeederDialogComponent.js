...
import seederData from "./complaints.seeder.json";
...
const ComplaintsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ComplaintsSeederDialogComponent);
