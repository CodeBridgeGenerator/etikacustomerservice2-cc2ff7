...
import seederData from "./refunds.seeder.json";
...
const RefundsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(RefundsSeederDialogComponent);
